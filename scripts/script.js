...
const loop = setInterval(() => {
 ...
 document.addEventListener('keydown', jump) //- Qualquer tecla tocada, efetuará a função
 document.addEventListener('touchstart', jump) //- Ao tocar na tela, efetuará a função
